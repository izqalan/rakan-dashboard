								...
								<div className="w-1/3 p-8">
									...
									<div className="pl-4 flex w-full h-full">
										<div className="flex flex-col items-start">
											<p className="font-semibold text-xs text-gray-400">Estimated Renovation cost*</p>
											<p className="font-semibold text-3xl text-white">RM 67,000</p>
											<p className="text-white text-xs font-normal">This space suitable to accommodate small to medium sized events. Avalable to accommodate 100-250 people at a time. </p>
											<p className="font-semibold text-xs text-white">Possible Renovation</p>
											<ul class="pl-4 list-disc text-xs text-white">
												<li>Study space / cubicle</li>
												<li>Common/event space</li>
